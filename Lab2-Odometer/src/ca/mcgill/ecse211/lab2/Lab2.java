...
public class Lab2 {
  ...
  public static final Port portColor = LocalEV3.get().getPort("S1");
  ...
  public static void main(String[] args) throws OdometerExceptions {
    ...
    OdometryCorrection odometryCorrection = new OdometryCorrection(odometer, portColor, sampleColor, myColor, myColorSample); // TODO Complete
                                                                      // implementation
